...
- Added Reasonix (DeepSeek coding agent CLI) integration: detection, full-lifecycle hook reporting, `reasonix --resume <id>` restore, and `herdr integration install reasonix`. (#954)
